    ...
    <div style={{ background: "#fff", borderRadius: 24, padding: "40px 32px", maxWidth: 420, width: "100%", textAlign: "center", boxShadow: "0 24px 80px rgba(0,0,0,0.3)" }}>
      ...
      {status === "checking" && (
        <>
          ...
          <div style={{ background: "#eff6ff", borderRadius: 12, padding: "12px 16px", fontSize: 13, color: "#1d4ed8" }}>
      ...
      {status === "success" && (
        <>
          ...
          <p style={{ color: "#6b7280", fontSize: 14, marginBottom: 20 }}>
            You're registered for <strong>{studentClass}</strong>.<br />Opening WhatsApp group now…
          </p>
          ...
          <a href={WHATSAPP_LINKS[studentClass] || "/"} target="_blank" rel="noopener noreferrer"
            style={{ display: "block", background: "#16a34a", color: "#fff", padding: "14px", borderRadius: 12, fontWeight: 700, fontSize: 15, textDecoration: "none", marginBottom: 10 }}>
            💬 Open WhatsApp Group
          </a>
          <button onClick={() => router.push("/")}
            style={{ width: "100%", background: "#f3f4f6", color: "#374151", padding: "12px", borderRadius: 12, fontWeight: 600, fontSize: 14, border: "none", cursor: "pointer" }}>
            Back to Home
          </button>
        </>
      )}
      ...
      {status === "failed" && (
        <>
          ...
          <button onClick={() => router.push("/")}
            style={{ width: "100%", background: "#2563eb", color: "#fff", padding: "14px", borderRadius: 12, fontWeight: 700, fontSize: 15, border: "none", cursor: "pointer", marginBottom: 10 }}>
            Try Again
          </button>
          <p style={{ fontSize: 12, color: "#9ca3af" }}>
            Need help? Call us at <a href="tel:9366030347" style={{ color: "#3b82f6" }}>9366030347</a>
          </p>
        </>
      )}
      ...
      {status === "pending" && (
        <>
          ...
          <p style={{ color: "#6b7280", fontSize: 14, marginBottom: 20 }}>
            We couldn't confirm your payment yet. If money was deducted, it will be verified within 24 hours.
          </p>
          <div style={{ background: "#fffbeb", border: "1px solid #fde68a", borderRadius: 12, padding: "12px 16px", fontSize: 13, color: "#92400e", marginBottom: 20 }}>
            Transaction ID: <strong style={{ wordBreak: "break-all" }}>{txnId}</strong>
          </div>
          <a href="https://wa.me/919366030347" target="_blank" rel="noopener noreferrer"
            style={{ display: "block", background: "#16a34a", color: "#fff", padding: "14px", borderRadius: 12, fontWeight: 700, fontSize: 15, textDecoration: "none", marginBottom: 10 }}>
            💬 Contact on WhatsApp
          </a>
          <button onClick={() => router.push("/")}
...
export default function PaymentStatusPage() {
  return (
    <main style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", background: "linear-gradient(135deg,#060f2e,#0d1b4b)", fontFamily: "'Outfit',sans-serif", padding: "20px" }}>
      <Suspense fallback={
        <div style={{ background: "#fff", borderRadius: 24, padding: "40px 32px", maxWidth: 420, width: "100%", textAlign: "center" }}>
          <div style={{ fontSize: 52, marginBottom: 16 }}>⏳</div>
