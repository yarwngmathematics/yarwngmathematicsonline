...
// ── Visitor counter ──────────────────────────────────────────────────
// NOTE: CounterAPI v1 (the old unauthenticated api.counterapi.dev/v1/...
// endpoint) was retired on Aug 7, 2026. The client no longer calls
// CounterAPI directly — it hits our own /api/visitor-count route, which
// holds the CounterAPI v2 access token server-side and forwards the
// request. See app/api/visitor-count/route.ts.
const VISITOR_COUNT_ENDPOINT = "/api/visitor-count";
